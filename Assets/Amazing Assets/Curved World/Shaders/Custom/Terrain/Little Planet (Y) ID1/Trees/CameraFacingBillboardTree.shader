...
Shader "Hidden/Amazing Assets/Curved World/Nature/Terrain/Little Planet (Y) 1/CameraFacingBillboardTree" 
{
    Properties{
        ...
        SubShader{
            Tags {
                "IgnoreProjector" = "True" "RenderType" = "CurvedWorld_TreeBillboard" }
