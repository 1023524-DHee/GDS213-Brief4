...
Shader "Hidden/Amazing Assets/Curved World/Nature/Terrain/Little Planet (Y) 1/Details/WavingDoublePass" {
Properties {
...
// vertex modifier: 'WavingGrassVert'
...
//#pragma surface surf Lambert vertex:WavingGrassVert addshadow fullforwardshadows exclude_path:deferred exclude_path:prepass
